...
### Prerequisites
- GNU Arm Embedded Toolchain (`arm-none-eabi-gcc` v14.3+)
- Make

### Compilation Command
```bash
PATH="/opt/st/stm32cubeide_2.1.1/plugins/com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.14.3.rel1.linux64_1.0.100.202602081740/tools/bin:$PATH" make -C Debug -j16 all
```

Output binary: `Debug/tensor_engine.elf`
